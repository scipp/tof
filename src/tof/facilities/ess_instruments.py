...
"""
Pre-configured chopper and detector parameters for ESS instruments.
"""
...
def _make_configuration(instrument) -> dict[str, list[Chopper] | list[Detector]]:
    choppers = [
        Chopper(
...
def odin_configuration() -> dict[str, list[Chopper] | list[Detector]]:
    return _make_configuration(odin)


def dream_configuration() -> dict[str, list[Chopper] | list[Detector]]:
    return _make_configuration(dream)
