...
class ComponentField:
    ...
    def __repr__(self) -> str:
        return (
            f"ComponentField(visible={sc.sum(self._mask).value}, "
...
class ComponentResult:
    ...
    @property
    def wavelengths(self) -> ComponentField:
        """
...
class Result:
    ...
    #         coll.set_norm(
    #             plt.Normalize(self._pulse.wav_min.value, self._pulse.wav_max.value)
    #         )
    #         if cbar:
    ...
    #         else:
    #             inds = slice(None)
    #         birth_times = self._pulse.birth_times[inv_mask][inds]
    ...
    #         else:
    #             inds = slice(None)
    #         birth_times = self._pulse.birth_times[furthest_detector._mask][inds]
    #         wavelengths = self._pulse.wavelengths[furthest_detector._mask][inds]
    ...
    #     # Plot pulse
    #     t_start = self._pulse.t_start.to(unit='us').value
    #     ax.plot(
    #         [t_start, self._pulse.t_end.to(unit='us').value],
    #         [0, 0],
    #         color="gray",
    #         lw=3,
    #     )
